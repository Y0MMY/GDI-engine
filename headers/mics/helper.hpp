...
public:
	...
	static RECT getAbsoluteRect(RectF relativeRect);
	static RECT getAbsoluteRect(Rect relativeRect);
	...
	static LPCWSTR GetSymbolFromVK(WPARAM wParam, int languageOnly = -1);
